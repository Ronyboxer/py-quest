# 🐍 PyQuest — Learn Python, the Duolingo way

A polished, fully client-side web app that teaches Python through bite-sized
lessons and real coding challenges. Your code **actually runs** in the browser
via Pyodide (CPython compiled to WebAssembly) — there is no backend and no
server. Progress, XP, and your daily streak live in `localStorage`.
...
- **Level map / skill tree** — a vertical, winding path grouped into 10 units.
